"""
Version simplifiee qui recalcule toutes les stats depuis zero.
Preferer updateStats.py pour de meilleures performances.
"""

def getStatsPlayersFromScratch(player1, player2, common, data):
    """
    Calcule les features pour un match en parcourant tout l'historique.
    Lent mais utile pour des tests ou predictions ponctuelles.
    """
    import numpy as np
    ...
    # Parcours de l'historique pour calculer les stats
    ...
    # Extraction des features finales
